...
```bash
npm install @stdlib/napi-argv-strided-uint32array2d
```
...
#### stdlib_napi_argv_strided_uint32array2d( env, M, N, strideX1, strideX2, value, \*\*data, \*message1, \*message2, \*err )
...
#### STDLIB_NAPI_ARGV_STRIDED_UINT32ARRAY2D( env, X, M, N, strideX1, strideX2, argv, index )
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/napi-argv-strided-uint32array2d.svg
[npm-url]: https://npmjs.org/package/@stdlib/napi-argv-strided-uint32array2d

[test-image]: https://github.com/stdlib-js/napi-argv-strided-uint32array2d/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/napi-argv-strided-uint32array2d/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/napi-argv-strided-uint32array2d/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/napi-argv-strided-uint32array2d?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/napi-argv-strided-uint32array2d.svg
[dependencies-url]: https://david-dm.org/stdlib-js/napi-argv-strided-uint32array2d/main
...
[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/napi-argv-strided-uint32array2d/main/LICENSE
